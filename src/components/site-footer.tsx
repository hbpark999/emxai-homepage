...
const mapLink =
  "https://www.google.com/maps/search/?api=1&query=%EA%B2%BD%EA%B8%B0%EB%8F%84%20%EC%88%98%EC%9B%90%EC%8B%9C%20%EC%98%81%ED%86%B5%EA%B5%AC%20%EC%8B%A0%EC%9B%90%EB%A1%9C%20250%EB%B2%88%EA%B8%B8%2013%20%ED%98%84%EB%8C%80%ED%85%8C%EB%9D%BC%ED%83%80%EC%9B%8C%20%EC%98%81%ED%86%B5%20B%EB%8F%99%201022%ED%98%B8";

export function SiteFooter() {
  return (
    <footer className="bg-[#2563eb] text-white">
      <div className="mx-auto w-full max-w-[94vw] px-6 py-4 sm:px-8 lg:max-w-[76vw] xl:max-w-[70vw]">
        <div className="grid gap-5 lg:grid-cols-[1fr_18rem] lg:items-center">
          <div className="space-y-3">
            <div>
              <p className="text-xl font-black">
                이엠엑스아이(주) <span className="text-lg font-semibold">EMxAI Inc.</span>
              </p>
              <p className="mt-1 max-w-5xl text-base font-semibold leading-6 text-white/90">
            ...
            <div className="flex flex-wrap justify-between gap-3 border-t border-white/20 pt-3 text-sm font-bold text-white/85">
              <p>Copyright © EMxAI Inc. All rights reserved.</p>
              <p>AI-powered EMI/SI Design · Analysis · Education</p>
            </div>
          </div>

          <div className="overflow-hidden rounded-md border border-white/25 bg-white/10 shadow-sm">
